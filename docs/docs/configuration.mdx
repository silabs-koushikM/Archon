...
- **LiteLLM** - Unified access to 100+ providers (OpenAI, Anthropic, Google, etc.)
...
- **LiteLLM**: Use any supported provider's API key (see [LiteLLM docs](https://docs.litellm.ai/docs/providers))
