...
MODEL_CHOICE=claude-3-5-sonnet-20240620  # Or any supported model
EMBEDDING_MODEL=text-embedding-3-small
# API Key: Use any supported provider's key (OpenAI, Anthropic, etc.)
# Pros: Unified interface, 100+ providers, easy switching
